...
public enum ComponentConfigurations implements ComponentConfiguration {
    ...
    LABEL(ComponentNames.LABEL, "Label", new Dimension(DX * 6, DY), JLabel.class, DEFAULT_FONT),
    TEXTFIELD(ComponentNames.TEXTFIELD, new Dimension(DX * 12, DY), JTextField.class, DEFAULT_FONT), ;
