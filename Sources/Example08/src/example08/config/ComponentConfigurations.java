...
public enum ComponentConfigurations implements ComponentConfiguration {
    ...
    COMBOBOX1(ComponentNames.COMBOBOX1, new Dimension(DX * 12, DY), JComboBox.class, DEFAULT_FONT),
    ...
    COMBOBOX2(ComponentNames.COMBOBOX2, new Dimension(DX * 12, DY), JComboBox.class, DEFAULT_FONT),
    LABEL4(ComponentNames.LABEL4, "Label#4", new Dimension(DX * 6, DY), JLabel.class, DEFAULT_FONT),
    COMBOBOX3(ComponentNames.COMBOBOX3, new Dimension(DX * 12, DY), JComboBox.class, DEFAULT_FONT),

    LABEL5(ComponentNames.LABEL5, "Label#5", new Dimension(DX * 6, DY), JLabel.class, DEFAULT_FONT),
    TEXTFIELD2(ComponentNames.TEXTFIELD2, new Dimension(DX * 12, DY), JTextField.class, DEFAULT_FONT),
    LABEL6(ComponentNames.LABEL6, "Label#6", new Dimension(DX * 6, DY), JLabel.class, DEFAULT_FONT),
    COMBOBOX4(ComponentNames.COMBOBOX4, new Dimension(DX * 12, DY), JComboBox.class, DEFAULT_FONT),
    LABEL7(ComponentNames.LABEL7, "Label#7", new Dimension(DX * 6, DY), JLabel.class, DEFAULT_FONT),
    TEXTFIELD3(ComponentNames.TEXTFIELD3, new Dimension(DX * 12, DY), JTextField.class, DEFAULT_FONT),

    BUTTON(ComponentNames.BUTTON, "Button", new Dimension(DX * 6, DY * 2), JButton.class, DEFAULT_FONT),

    LIST(ComponentNames.LIST, new Dimension(DX * 18, DY * 18), JList.class, DEFAULT_FONT),
    TEXTAREA(ComponentNames.TEXTAREA, new Dimension(DX * 18, DY * 18), JTextArea.class, DEFAULT_FONT), ;
